...
class SpeechConsumer(WebsocketConsumer):
    ...
    def connect(self):
        ...
        reactions = list(models.SttReaction.objects.filter(active=True))
        self.stt = SttAnalyzer(reactions)
...
class SttAnalyzer:
    ...
    def __init__(self, reaction_models: Collection[models.SttReaction]):
