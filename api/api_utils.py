...
def add_sound_effect_count_annotation(user: User, qs: QuerySet):
    ...
    my_play_count_month = Count("play_history", filter=Q(play_history__played_by=user), distinct=False)
    ...
    return qs.annotate(my_total_play_count=my_total_play_count, my_play_count_month=my_play_count_month,
